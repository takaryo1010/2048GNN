...
main_config = dict(
    exp_name='data_gat_stochastic_3x3/game_2048_grid3_gat_stochastic_ns100_upc200_rer0.0_bs512_heads4_seed0_250805_153932',
    env=dict(
        manager=dict(
    ...
    policy=dict(
        model=dict(
            ...
            state_norm=False,
            flatten_input_size_for_value_head=144,
            flatten_input_size_for_policy_head=144,
        ),
        learn=dict(
            learner=dict(
