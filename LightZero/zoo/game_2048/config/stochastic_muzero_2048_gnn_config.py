"""
Configuration for GNN-based Stochastic MuZero on 2048
...
game_2048_gnn_stochastic_muzero_create_config = dict(
    ...
    # Register GNN model
    model=dict(
        type='GNNStochasticMuZeroModel',
        import_names=['lzero.model.gnn_stochastic_muzero_model'],
    ),
)
