exp_config = {
    ...
    'policy': {
        ...
        'model_path':
        './data_gnn_stochastic_mz/gnn_simple_success1/ckpt/iteration_79400.pth.tar',
        'reanalyze_ratio': 0.0,
        'eval_freq': 200,
    ...
    'exp_name':
    'data_gnn_stochastic_mz/game_2048_gnn_npct-2_ns100_upc200_rer0.0_bs512_gnn3L128D_sparse_seed0_251010_145740',
    'seed': 0
}
